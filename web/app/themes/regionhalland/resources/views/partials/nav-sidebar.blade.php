...
@if(function_exists('get_region_halland_current_page_and_child_pages'))
	...
	@if(isset($myPages))
		<ul class="rh-secondary-nav">
			<a class="rh-secondary-nav-link" style="color:white; font-size: 1.3em; font-weight:bold;"><li class="rh-secondary-nav-item-parentlevel" style="color: #378A30; background-color:#E4E4E4; border:none;">

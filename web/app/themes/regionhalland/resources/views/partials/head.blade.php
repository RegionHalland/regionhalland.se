<head>
	...
	<link rel="stylesheet" href="{!! env('WP_HOME') !!}/include/style/regionhalland.1.2.1-5.1.0.css" type="text/css" media="all" />
	<link rel="stylesheet" href="{!! env('WP_HOME') !!}/include/style/development.1.0.0.css" type="text/css" media="all" />
	<style>
		.rh-article ul {

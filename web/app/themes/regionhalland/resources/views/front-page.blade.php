...
@section('content')
    <nav aria-label="Undersidor" style="background-color: #F4F4F4;">
        <ul class="flex flex-wrap px3 pt3 center" title="Lista på undersidor" style="max-width: 1440px;">
    ...
    <main id="main">
        ...
        @if(isset($myBlurbs))
        <ul class="clearfix center mb2 mt2" title="Puffar" style="max-width:1440px;">
